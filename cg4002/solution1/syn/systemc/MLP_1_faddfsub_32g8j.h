...
// ==============================================================
#ifndef __MLP_1_faddfsub_32g8j__HH__
#define __MLP_1_faddfsub_32g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(MLP_1_faddfsub_32g8j) {
    ...
    SC_CTOR(MLP_1_faddfsub_32g8j):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
