...
// ==============================================================
#ifndef __MLP_1_fcmp_32ns_3ibs__HH__
#define __MLP_1_fcmp_32ns_3ibs__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(MLP_1_fcmp_32ns_3ibs) {
    ...
    SC_CTOR(MLP_1_fcmp_32ns_3ibs):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
