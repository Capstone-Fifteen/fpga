...
set genomeRtd $env(RT_TMP)/56CF1830.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {dot_product_2__GB2}]"
...
set genomeName [subst -nocommands -novariables {dot_product_2__GB2}]
